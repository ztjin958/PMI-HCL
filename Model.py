...
class protein_HGNN(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels):
        ...
        self.conv1 = HypergraphConv(in_channels, hidden_channels, dropout=0.5)
        self.pb1 = nn.BatchNorm1d(hidden_channels)
        self.conv2 = HypergraphConv(hidden_channels, out_channels, dropout=0.5)
...
class HGCN(torch.nn.Module):
    ...
    def hypergraph_contrastive_loss(self, z1, z2, temperature=0.5):
        """
