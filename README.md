...
- Proteins: Amino acid sequences are encoded using ProtT5 to generate the initial protein feature matrix .
...
- Graph-based Knowledge Integration: Structural information from STITCH (for metabolites) and STRING (for proteins) is utilized.K-Nearest Neighbors (KNN) is applied to construct hypergraphs at different scales.
